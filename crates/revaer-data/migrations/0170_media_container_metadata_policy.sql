ALTER TABLE media_desired_target_container
    ADD COLUMN container_metadata_policy TEXT NOT NULL DEFAULT 'preserve',
    ADD CONSTRAINT media_desired_target_container_metadata_policy_known CHECK (
        container_metadata_policy IN ('preserve')
    );

ALTER TABLE media_job
    ADD COLUMN intent_desired_container_metadata_policy TEXT;

UPDATE media_job
   SET intent_desired_container_metadata_policy = 'preserve'
...
ALTER TABLE media_job
    ...
    ADD CONSTRAINT media_job_intent_desired_target_complete CHECK (
        ...
        (intent_desired_target_profile_id IS NOT NULL
            ...
            AND intent_desired_container_metadata_policy = 'preserve')
    );

CREATE FUNCTION media_desired_target_create_v2(
...
BEGIN
    ...
    IF NULLIF(btrim(target_key_input), '') IS NULL
       ...
       OR metadata_policy_value <> 'preserve' THEN
...
CREATE FUNCTION media_desired_target_list_v2()
RETURNS TABLE (
...
BEGIN
    ...
    INSERT INTO media_job (
        ...
        intent_desired_container_metadata_policy, intent_unmatched_stream_policy,
    ...
    VALUES (
        ...
        desired_container_metadata_policy, policy_row.unmatched_stream_policy,
