...
const MAX_CONTAINER_CHAPTERS: usize = 1_024;
const MAX_CONTAINER_CHAPTER_METADATA_ENTRIES: usize = 64;
const MAX_CONTAINER_CHAPTER_METADATA_TOTAL_BYTES: usize = 65_536;
