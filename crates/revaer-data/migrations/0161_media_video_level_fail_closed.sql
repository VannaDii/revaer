...
ALTER TABLE media_desired_target_stream
    ADD CONSTRAINT media_desired_target_stream_video_level_known CHECK (
        media_video_level_known_v1(codec, video_level)
    );

ALTER TABLE media_job_desired_target_stream
    ADD CONSTRAINT media_job_desired_target_stream_video_level_known CHECK (
        media_video_level_known_v1(codec, video_level)
    );
