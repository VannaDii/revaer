...
mod tests {
    use super::{
        ...
        SystemFfmpegAudioAnalysisAdapter, SystemSourceFingerprintProbe, audio_measurement_mismatch,
        expected_audio_constraints, parse_ebur128_summary, validate_claimed_source_fingerprint,
        verification_policy_from_job, video_policy_from_policy_intent,
