...
6. **Tag & Publish**
    ...
    - After Artifact Hub shows `Verified publisher`, file the `official` status request for the Revaer publisher or organization. Use `revaer-logo.svg` for the Artifact Hub repository and organization logo during that setup.
