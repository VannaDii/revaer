...
- `just test-media-conversion` must verify the prepared fixture catalog before running the ignored real-media integration suite; PR fixture jobs must invoke this canonical recipe and clean generated media under an always-run step.
