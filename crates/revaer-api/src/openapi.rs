...
fn media_desired_target_stream_schema() -> Value {
    object_schema(
        ...
        [
            ...
            ("video_width_px", integer_schema()),
            ("video_height_px", integer_schema()),
            ("video_pixel_format", string_schema()),
            ("video_bit_depth", integer_schema()),
            ("video_average_frame_rate", string_schema()),
            ("color_range", string_schema()),
...
mod tests {
    ...
    #[test]
    fn openapi_document_exports_unmatched_action_values() {
        let document = openapi_document();
        let unmatched_video_enum = document["components"]["schemas"]["MediaPolicyUpsertRequest"]
            ["properties"]["unmatched_video_action"]["enum"]
            .as_array()
