...
- Test coverage summary:
  - Added focused app tests for channel-count mismatch, channel-layout mismatch, and supported layout alias acceptance.
  - Reran focused media-job runtime tests and the NVM Node wrapper smoke check.
