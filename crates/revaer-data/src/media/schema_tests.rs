...
const EXPECTED_TABLES: &[&str] = &[
    ...
    "media_desired_target_container_chapter",
    "media_desired_target_container_chapter_metadata",
    "media_desired_target_container_metadata",
    "media_desired_target_stream",
    "media_desired_target_audio_stream",
    "media_job_desired_target_metadata",
    "media_job_desired_target_chapter",
    "media_job_desired_target_chapter_metadata",
...
const EXPECTED_PROCS: &[&str] = &[
    ...
    "media_desired_target_create_v2",
    "media_desired_target_create_v3",
    "media_desired_target_create_v4",
    "media_desired_target_chapter_append_v1",
    "media_desired_target_chapter_metadata_append_v1",
    "media_desired_target_chapter_list_v1",
    "media_desired_target_metadata_append_v1",
    "media_desired_target_metadata_list_v1",
    ...
    "media_desired_target_stream_append_v7",
    "media_desired_target_stream_append_v8",
    "media_video_level_known_v1",
    "media_video_pixel_format_valid_v1",
    "media_video_bit_depth_supported_v1",
    "media_video_pixel_format_bit_depth_v1",
    "media_video_color_range_known_v1",
    "media_video_frame_rate_reduce_v1",
    "media_video_frame_rate_valid_v1",
    "media_audio_channel_layout_count_v1",
    "media_desired_target_list_v1",
    "media_desired_target_graph_page_v1",
    "media_desired_target_list_v2",
    "media_desired_target_list_v3",
    "media_desired_target_list_v4",
    ...
    "media_desired_target_stream_list_v7",
    "media_desired_target_stream_list_v8",
    ...
    "media_job_desired_target_stream_list_v7",
    "media_job_desired_target_stream_list_v8",
    ...
    "media_job_worker_claim_next_v4",
    "media_job_worker_claim_next_v5",
