ALTER TABLE media_desired_target_stream
    ADD CONSTRAINT media_desired_target_stream_hdr_format_known CHECK (
        hdr_format IS NULL OR hdr_format IN ('hdr10')
    );

ALTER TABLE media_job_desired_target_stream
    ADD CONSTRAINT media_job_desired_target_stream_hdr_format_known CHECK (
        hdr_format IS NULL OR hdr_format IN ('hdr10')
    );
