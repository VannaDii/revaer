...
- Decision:
  ...
  - Treat this as a nonarchitectural corrective task record awaiting ADR 461 status semantics; no architectural decision is introduced.
  - The code correction may proceed under the operator's direct instruction because it makes no architectural choice, but this record remains proposed until the operator approves its status treatment.
- Consequences:
