...
`just test-media-conversion` also records fixture validation, metadata checks,
production pipeline materialization actions, and audio/video transcode counts
